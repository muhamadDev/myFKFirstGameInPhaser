export default class SceneMenu extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image(`GUIContainer`, `https://muhamaddev.github.io/myFKFirstGameInPhaser/assets/ui/GUIContainer.png`);
        
        this.load.spritesheet("GUI", "https://muhamaddev.github.io/myFKFirstGameInPhaser/assets/ui/GUI.png", {
            frameWidth: 49,
            frameHeight: 16 ,
            frameRate: 1
        });
        
        this.load.spritesheet("GUIText", "https://muhamaddev.github.io/myFKFirstGameInPhaser/assets/ui/GUIText.png", {
            frameWidth: 26,
            frameHeight: 9,
            frameRate: 1
        });
        
        this.load.audio('music', ['https://muhamaddev.github.io/myFKFirstGameInPhaser/assets/audio/music.ogg', 'https://muhamaddev.github.io/myFKFirstGameInPhaser/assets/audio/music.mp3']);
